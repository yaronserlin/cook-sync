 ...
 * Encapsulates full unit display name (singular and plural) and short unit symbol code.
 *
 * @param name the full singular name of the measurement unit, between 2 and 50 characters
 * @param namePlural the full plural name of the measurement unit (e.g. "Grams" for "Gram"),
...
public record UnitRequestDTO(
        ...
        @NotBlank(message = "Unit plural name cannot be blank")
        @Size(min = 2, max = 50, message = "Unit plural name must be between 2 and 50 characters")
        String namePlural,
