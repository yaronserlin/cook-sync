 ...
 * {@link AuthService#purgeExpiredPendingRegistrations()} for the actual purge logic.
 *
 * @author Yaron Serlin
 * @version 1.0
 * @since 13/08/2026
...
public class PendingRegistrationCleanupScheduler {
    ...
    /**
     * Runs once a day and delegates to {@link IAuthService#purgeExpiredPendingRegistrations()}.
     *
     * Complexity:
