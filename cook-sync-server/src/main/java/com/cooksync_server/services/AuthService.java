 ...
 * in {@link UserProfileService}; password change/reset lives in {@link PasswordService}.
...
public class AuthService implements IAuthService {
    ...
    public AuthService(UserRepository userRepository, PasswordEncoder passwordEncoder, JwtUtil jwtUtil,
            IRefreshTokenService refreshTokenService, PendingRegistrationRepository pendingRegistrationRepository,
            IEmailService emailService, IAccountDeletionService accountDeletionService) {
     ...
     * (via {@link RefreshTokenService#createRefreshToken(String)}, which already deletes any
