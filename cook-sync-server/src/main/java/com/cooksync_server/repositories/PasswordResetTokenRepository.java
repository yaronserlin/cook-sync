...
public interface PasswordResetTokenRepository extends JpaRepository<PasswordResetToken, String> {
    ...
    /**
     * Finds the active PasswordResetToken row for a specific user, if one exists (at most one
     * per user at a time, since a fresh forgot-password request deletes any prior row first).
     *
